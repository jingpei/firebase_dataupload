  portfolioApp.controller("PortfolioViewerController", function($scope, $routeParams, FIREBASE_URL, $firebaseArray, $firebaseObject){
    ...
    var pushImg = new Firebase(FIREBASE_URL + '/images/' + $scope.portfolio_name)
   //  pushImg.set({
    ...
    // if (portfolios.$getRecord($scope.portfolio_name)) {
    //   $scope.portfolios = portfolios.$getRecord($scope.portfolio_name);
